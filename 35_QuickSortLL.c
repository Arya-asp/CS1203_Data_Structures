...
//function QuickSortasc() takes in a pointer to the head node of the linked list and sorts the linked list in ascending order
void QuickSortasc(my_node* head) {
    my_node* current = head;
    my_node* max = head;
    while (current != NULL) {
    ...
    swap(max, head);
    if (head->next != NULL) {
        QuickSortasc(head->next);
    }
}


//function QuickSortdesc() takes in a pointer to the first node of the linked list and sorts the entire linked list in descending order
void QuickSortdesc(my_node* head) {
    my_node* current = head;
    my_node* min = head;
    while (current != NULL) {

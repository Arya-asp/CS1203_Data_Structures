//Look for new code starts here, explanation for previous code is in 01_FiguringOutArrays.c
...
//function main() asks for the size of array and the inputs and then generates an array and prints it using generateArray() and printArray() functions and then creates a linked list from the array and prints it using arrayToList() and printList() functions
int main() {
    int size;
